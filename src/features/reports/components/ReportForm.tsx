...
const reportSchema = z.object({
    ...
    steps: z.string().max(3000, 'Maximo 3000 caracteres').optional(),
})
        ...
        >
            ...
            <div>
                ...
                <textarea
                    ...
                    placeholder="Que paso, que esperabas y como lo reproducimos"
            ...
            <div>
                <label htmlFor="report-steps" className="label">Pasos (opcional)</label>
                <textarea
                    id="report-steps"
                    rows={4}
                    className="input resize-none"
                    ...
                    {...register('steps')}
                />
                {errors.steps ? <p className="text-xs text-red-400 mt-1">{errors.steps.message}</p> : null}
            </div>
